 ...
 */
@WebServlet("/home/classes/assignment/edit")
public class AcademyClassSubjectTeacherEditServlet extends HttpServlet {
	 ...
	 */
	public AcademyClassSubjectTeacherEditServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			switch (action) {
			case "/home/classes/assignment/edit":
	...
	private void showEditForm(HttpServletRequest request, HttpServletResponse response)
		...
		if(request.getAttribute("academyClassSubjectTeacher") == null) {
			request.setAttribute("academyClassSubjectTeacher", academyClassSubjectTeacherDAO.getClassSubjectTeacher(id));
		}
