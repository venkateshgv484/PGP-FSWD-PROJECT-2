 ...
 */
@WebServlet("/home/classes/assignment/list")
public class AcademyClassSubjectTeacherListServlet extends HttpServlet {
	 ...
	 */
	public AcademyClassSubjectTeacherListServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			switch (action) {
			case "/home/classes/assignment/list":
	...
	private void list(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<AcademyClassSubjectTeacher> academyClassSubjectTeachers = academyClassSubjectTeacherDAO.listAllClassSubjectTeachers(classId);
		request.setAttribute("academyClass", academyClassDAO.getClass(classId));
		request.setAttribute("academyClassSubjectTeacherList", academyClassSubjectTeachers);
		request.setAttribute("subjectMap", loadSubjects());
		request.setAttribute("teacherMap", loadTeachers());
		RequestDispatcher dispatcher = request.getRequestDispatcher("class-assignment-list.jsp");
